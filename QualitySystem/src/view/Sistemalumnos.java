...
public class Sistemalumnos extends javax.swing.JDialog {
    ...
    private void cargarDatos(){
        ...
        for (String [] fila : datos){
            double n1 = parseNota(fila[4]);
            double n2 = parseNota(fila[5]);
            double n3 = parseNota(fila[6]);
            suma += (n1 + n2 + n3) / 3;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(190, 90, 170, 20);
        ...
        jButton1.setBounds(470, 400, 120, 35);
