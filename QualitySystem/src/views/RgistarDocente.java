 ...
 * @author franz
 */
public class RgistarDocente extends javax.swing.JDialog {
    ControllerLogin log = new ControllerLogin();
    ModeloRegistroDocente mrd = new ModeloRegistroDocente();
    ARdocentes doc = new ARdocentes();
    /**
     * Creates new form RgistarDocente
     */
    public RgistarDocente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Limpiar();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RgistarDocente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RgistarDocente dialog = new RgistarDocente(new javax.swing.JFrame(), true);
